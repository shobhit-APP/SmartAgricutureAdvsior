...
public interface UserService {
    ...
    boolean resetPassword(String email, String newPassword ,UserDetails1 user);
    ...
    boolean sendVerificationEmail(Long userId, String email, String phone,String context);
    ...
    UserDetails1 findById(Long userId);
}